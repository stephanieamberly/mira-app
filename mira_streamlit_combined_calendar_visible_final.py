...
# Responsive, centered MIRA header with large logo
import base64
...
with col2:
    st.markdown(
        ...
        <div class="mira-header">
            <img src="data:image/png;base64,{mira_img_base64}" alt="MIRA Logo" />
            <h1>MIRA
    )

# Ask MIRA
st.subheader("🧠 What can I take off your plate today?")
if st.button("🎤 Start Listening"):
    try:
        ...
        st.warning("Sorry, we couldn't capture audio input.")
